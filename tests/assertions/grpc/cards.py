...
from protos.gen.contracts.services.cards.card_pb2 import Card

logger = get_test_logger("GRPC_CARDS_ASSERTIONS")


@allure.step("Check gRPC card")
def assert_card(actual: Card, expected: Card) -> None:
    logger.info("Check gRPC card")
