...
from protos.gen.contracts.services.accounts.account_pb2 import Account

logger = get_test_logger("GRPC_ACCOUNTS_ASSERTIONS")


@allure.step("Check gRPC account")
def assert_account(actual: Account, expected: Account) -> None:
    logger.info("Check gRPC account")
